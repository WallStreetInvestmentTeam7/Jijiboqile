...
#Visualization <- function(marketOrders, posList1, posList2, date, dateList){
#  if (is.vector(marketOrders) <- TRUE){
#    pos1 <- marketOrders[,1]
#    posList1 <- append(posList1, pos1)
#  }
#  else {
#    posList1 <- append(posList1, 0)
#  }
#  #posList <- append(posList,pos)
#  dateList <- append(dateList,date)
#  plot(dateList, posList1, type="l", xlab="day", ylab="Position Traded", main="Original")
#}
